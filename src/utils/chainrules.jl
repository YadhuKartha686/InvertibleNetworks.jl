...
"""
function check_coherence(state::InvertibleOperationsTape, net::Union{NeuralNetLayer,InvertibleNetwork,Reverse})
...
"""
function forward_update!(state::InvertibleOperationsTape, X::AbstractArray{T,N}, Y::AbstractArray{T,N}, logdet::Union{Nothing,T}, net::Union{NeuralNetLayer,InvertibleNetwork,Reverse}) where {T, N}
...
function pullback(net::Union{NeuralNetLayer,InvertibleNetwork,Reverse}, ΔY::AbstractArray{T,N};
...
function ChainRulesCore.rrule(net::Union{NeuralNetLayer,InvertibleNetwork,Reverse}, X::AbstractArray{T, N};
                              state::InvertibleOperationsTape=GLOBAL_STATE_INVOPS) where {T, N}
